...
// ReverbStudio with Governance.
contract ReverbStudio is ERC20('Reverb Token', 'REVERB'), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "FUZZ::delegateBySig: signature expired");
